...
console.log(
  "   Order:",
  typeof Order === "function" ? "✅ Loaded" : "❌ Failed",
);
console.log(
  "   MenuItem:",
  typeof MenuItem === "function" ? "✅ Loaded" : "❌ Failed",
);
console.log(
  "   Category:",
  typeof Category === "function" ? "✅ Loaded" : "❌ Failed",
);
console.log(
  "   Settings:",
  typeof Settings === "function" ? "✅ Loaded" : "❌ Failed",
);
console.log(
  "   PaymentSession:",
  typeof PaymentSession === "function" ? "✅ Loaded" : "❌ Failed",
);
console.log("");
...
app.listen(PORT, () => {
  ...
  console.log(
    "   GET    /api/orders/kitchen/live - Get active orders (Kitchen)",
  );
  ...
  console.log(
    "   GET    /api/print-jobs/pending  - Bridge polls for print jobs",
  );
  ...
  console.log("\n🧪 Test Endpoints:");
  console.log("   GET    /api/test-email          - Test email sending");
